  ...
  if (inter.commandName === 'pioche') {
    ...
    try {
      ...
      if (owned.length) {
        ...
        await pool.query(`INSERT INTO koins(user_id, amount) VALUES ($1, $2) ON CONFLICT (user_id) DO UPDATE SET amount = koins.amount + $2`, [uid, gain]);
        bonusMsg = `💰 Carte en double ! Tu gagnes ${gain} koins.`;
      } else {
